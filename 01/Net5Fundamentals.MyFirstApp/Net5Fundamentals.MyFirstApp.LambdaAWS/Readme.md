...
Execute unit tests
```
    cd "Net5Fundamentals.MyFirstApp.LambdaAWS/test/Net5Fundamentals.MyFirstApp.LambdaAWS.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Net5Fundamentals.MyFirstApp.LambdaAWS/src/Net5Fundamentals.MyFirstApp.LambdaAWS"
